...
<title>Regras de Pontuação — Morningfall Creators</title>
...
.back{display:inline-block;margin-bottom:34px}
...
<main class="rules-wrap">
  <a class="back" href="index.php">← Meu painel</a>

  <p class="eyebrow">MORNINGFALL CREATORS</p>
  <h1>Regras de Pontuação</h1>
  <p class="muted">Confira como os pontos, metas e conteúdos são contabilizados. Todos os envios passam pela análise da Staff.</p>
